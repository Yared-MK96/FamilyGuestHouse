      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="relative h-36 bg-cover bg-center" style={{ backgroundImage: 'url("/hotel_hero.png")' }}>
          <div className="absolute inset-0 bg-primary/80 flex flex-col items-center justify-center">
            ...
            <p className="text-gray-200 text-sm mt-1">Join Family Guest House</p>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" {...register('name')} placeholder="John Doe"
                  className={`w-full pl-10 pr-4 py-3 rounded-lg border ${errors.name ? 'border-red-400' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary`}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPass ? 'text' : 'password'} {...register('confirmPassword')} placeholder="••••••••"
                  className={`w-full pl-10 pr-4 py-3 rounded-lg border ${errors.confirmPassword ? 'border-red-400' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary`}
                />
              </div>
